...
// Debug prints the token to the console
...
// isOneOfMany checks if the token is one of the expected tokens
...
// TokenKindString returns the string representation of the token kind
